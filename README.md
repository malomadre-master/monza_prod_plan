...
Первый вход: **admin** / пароль из `BOOTSTRAP_ADMIN_PASSWORD` (по умолчанию задан в настройках стенда). При старте API учётка admin синхронизируется с этим паролем. Заказы вводят роли admin и планировщик.
