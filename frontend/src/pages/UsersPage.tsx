...
import { Button, Group, Paper, PasswordInput, Select, Stack, Table, Text, TextInput, Title } from "@mantine/core";
...
export function UsersPage() {
  ...
  async function createUser(event: React.FormEvent) {
    ...
    try {
      await api("/api/users", {
        method: "POST",
        body: JSON.stringify({ username, display_name: displayName, password, role, is_active: true }),
      });
      setUsername("");
      setDisplayName("");
      setPassword("");
